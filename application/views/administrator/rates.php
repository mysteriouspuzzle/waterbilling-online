        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
                <strong class="card-title">Rates</strong>
            </div>
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $rate->cubic_meter ?></td>
              <td><?php echo $rate->rate ?></td>
              <td><button data-toggle="modal" data-target="#myModal" data-id="<?php echo $rate->id ?>" data-cubicmeter="<?php echo $rate->cubic_meter ?>" data-minimum="<?php echo $rate->minimum ?>" data-maximum="<?php echo $rate->maximum ?>"  data-rate="<?php echo $rate->rate ?>" class="btn btn-info"><span class="ti ti-pencil"></span> Edit</button></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
